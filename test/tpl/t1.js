...
module.exports = function(scope, __mc__observe) {
    ...
    (function(scope, tree) { // startTree 0
        ...
        __parserBinders(__mc__binderData, __mc__isBindObserve, 'data-id', __mc__attr['data-id']);
        (function(scope, tree) { // startTree 1
            ...
            for (var v in __mc__obj) {
                ...
                __parserBinders(__mc__binderData, __mc__isBindObserve, 'href', __mc__attr['href']);
